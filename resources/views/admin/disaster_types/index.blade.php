    ...
    <div class="py-6 container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center mb-6">
            <div class="text-sm text-gray-500 dark:text-gray-400">
                <i class="fas fa-bolt mr-1"></i> Manage your Disaster Types
            </div>
            <a href="{{ route('admin.disaster-types.create') }}"
                ...
                <i class="fas fa-plus-circle mr-2"></i> Create New Disaster Type
            </a>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden border border-gray-200 dark:border-gray-700">
            <div class="px-6 py-4 bg-gray-700">
                <h3 class="text-lg font-medium text-white flex items-center">
                    <i class="fas fa-bolt mr-2"></i> All Disaster Types
                </h3>
            </div>
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    <thead class="bg-gray-50 dark:bg-gray-700">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase">Incident Type</th>
                    ...
                    <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        @forelse($disasterTypes as $disaster)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                <td class="px-6 py-4 text-sm text-gray-900 dark:text-gray-100">{{ $disaster->name }}</td>
                                <td class="px-6 py-4 text-sm text-gray-700 dark:text-gray-400">{{ $disaster->incidentType->name ?? '-' }}</td>
                                ...
                                <td class="px-6 py-4 text-right space-x-2">
                                    <a href="{{ route('admin.disaster-types.edit', $disaster->id) }}" class="px-3 py-1 bg-yellow-500 text-white rounded-lg shadow hover:bg-yellow-600 transition"><i class="fas fa-edit mr-1"></i>Edit</a>
                                    <form action="{{ route('admin.disaster-types.destroy', $disaster->id) }}" method="POST" class="inline">
                                        @csrf @method('DELETE')
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="text-center px-6 py-4 text-gray-500 dark:text-gray-400">No Disaster Types found.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
