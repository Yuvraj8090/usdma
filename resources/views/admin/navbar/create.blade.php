    ...
    <x-slot name="header">
        <div class="flex items-center space-x-4">
            <a href="{{ route('admin.navbar-items.index') }}" 
               class="text-gray-700 dark:text-white hover:text-indigo-800 dark:hover:text-indigo-200 transition-colors">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label for="title" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                                <span class="text-gray-700">*</span> Title
                            </label>
                        ...
                        <div>
                            <label for="slug" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                                <span class="text-gray-700">*</span> Slug
                            </label>
                            <div class="relative mt-1">
                                ...
                                <button type="button" onclick="generateSlug()"
                                        class="absolute right-3 top-2.5 text-gray-700 dark:text-white 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="flex items-center space-x-2">
                            ...
                            <input type="checkbox" name="is_dropdown" id="is_dropdown" value="1" {{ old('is_dropdown') ? 'checked' : '' }}
                                   class="h-4 w-4 text-gray-700 focus:ring-indigo-500 border-gray-300 dark:border-gray-600 dark:bg-gray-700 rounded">
