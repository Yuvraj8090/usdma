            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden border border-gray-200 dark:border-gray-700">
                ...
                <div class="p-6">
                    <form action="{{ route('admin.equipment.store') }}" method="POST">
                        ...
                        <!-- Code -->
                        <div class="mb-4">
                            <label for="code" class="block text-gray-700 dark:text-gray-300 font-semibold">Code *</label>
                        ...
                        <!-- Category -->
                        <div class="mb-4">
                            <label for="category_id" class="block text-gray-700 dark:text-gray-300 font-semibold">Category</label>
                        ...
                        <!-- District -->
                        <div class="mb-4">
                            <label for="district_id" class="block text-gray-700 dark:text-gray-300 font-semibold">District</label>
