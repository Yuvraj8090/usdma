            ...
            <div
                ...
                <div class="p-6">
                    <form action="{{ route('admin.equipment.store') }}" method="POST">
                        ...
                        <!-- Name -->
                        <div class="mb-4">
                            <label for="name" class="block text-gray-700 dark:text-gray-300 font-semibold">Name
                                *</label>
                        ...
                        <!-- Code -->
                        <div class="mb-4">
                            <label for="code" class="block text-gray-700 dark:text-gray-300 font-semibold">Code
                                *</label>
                        ...
                        <div class="mb-4">
                            <label for="category_id"
                                class="block text-gray-700 dark:text-gray-300 font-semibold">Category</label>
                        ...
                        <div class="mb-4">
                            <label for="district_id"
                                class="block text-gray-700 dark:text-gray-300 font-semibold">District</label>
                        ...
                        <!-- Quantity -->
                        <div class="mb-4">
                            <label for="quantity" class="block text-gray-700 dark:text-gray-300 font-semibold">Quantity
                                *</label>
                        ...
                        <div class="mb-4">
                            <label for="remarks"
                                class="block text-gray-700 dark:text-gray-300 font-semibold">Remarks</label>
                        ...
                        <div class="flex justify-end space-x-3">
                            <a href="{{ route('admin.equipment.index') }}"
                                class="px-5 py-2.5 bg-gray-500 text-white rounded-lg shadow hover:bg-gray-600 transition duration-200">
                                Cancel
                            </a>
                            <button type="submit"
                                class="px-5 py-2.5 bg-gradient-to-r from-indigo-500 to-purple-500 text-white rounded-lg shadow hover:from-indigo-600 hover:to-purple-600 transition duration-200">
