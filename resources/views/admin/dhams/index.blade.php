<x-app-layout>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        @forelse($dhams as $dham)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                <td class="px-6 py-4 text-sm text-gray-900 dark:text-gray-100">{{ $dham->name }}</td>
    ...
    {{ $dham->is_winter == 1 ? 'Yes' : 'No' }}
                                ...
                                <td class="px-6 py-4 text-right text-sm font-medium space-x-2">
                                    ...
                                    <form action="{{ route('admin.dhams.destroy', $dham->id) }}" method="POST" class="inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
                                            ...
                                            onclick="return confirm('Are you sure you want to delete this dham?')">
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="text-center px-6 py-4 text-gray-500 dark:text-gray-400">No dhams found.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
