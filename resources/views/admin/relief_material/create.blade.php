<x-app-layout>
    ...
    <div class="py-6 container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 shadow-lg rounded-xl p-6 border border-gray-200 dark:border-gray-700">
            <form action="{{ route('admin.relief_material.store') }}" method="POST">
                @csrf
                ...
                <div class="mb-4">
                    ...
                    <textarea name="remarks" rows="3"
                        class="w-full rounded-lg border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100">{{ old('remarks') }}</textarea>
                ...
                <div class="flex justify-end space-x-3">
                    ...
                    <button type="submit" 
                        class="px-4 py-2 bg-gray-700 text-white font-semibold rounded-lg shadow hover:from-indigo-600 hover:to-purple-600">
                        Save
                    </button>
                </div>
            </form>
