<div
    ...
    <div>
        ...
        <nav class="space-y-2">
            ...
            {{-- User Management --}}
            <x-sidebar.dropdown icon="fas fa-user-shield" label="Admin" :active="request()->routeIs('admin.users.*') || request()->routeIs('admin.roles.*')">
                ...
                <x-sidebar.dropdown icon="fas fa-users-cog" label="User Management" :active="request()->routeIs('admin.users.*') || request()->routeIs('admin.roles.*')">
                    ...
                    <x-sidebar.link route="admin.users.index" label="Users" :active="request()->routeIs('admin.users.*')" icon="fas fa-user" />

                    <x-sidebar.link route="admin.roles.index" label="Roles" :active="request()->routeIs('admin.roles.*')" icon="fas fa-user-tag" />
            ...
            {{-- Accidental Reports --}}
            <x-sidebar.dropdown icon="fas fa-car-crash" label="Accidental Reports" :active="request()->routeIs('admin.accidental_reports.*') ||
            ...
            {{-- Locations --}}
            <x-sidebar.dropdown icon="fas fa-map-marker-alt" label="Locations" :active="request()->routeIs('admin.states.*') ||
                request()->routeIs('admin.districts.*') ||
                request()->routeIs('admin.dhams.*') ||
                request()->routeIs('admin.district-users.*')">
    ...
    <div class="mt-6">
        <div
            class="flex items-center p-3 border-t dark:border-gray-700 bg-gray-50 dark:bg-gray-800 rounded-md transition-colors">
