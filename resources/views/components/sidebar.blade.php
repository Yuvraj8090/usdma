...
<nav class="space-y-2">
    ...
    <x-sidebar.dropdown icon="fas fa-user-shield" label="Admin" :active="request()->routeIs('admin.*')">
        ...
        <x-sidebar.dropdown icon="fas fa-car-crash" label="Accidental Reports" :active="request()->routeIs('admin.accidental-reports-fillable.*') || request()->routeIs('admin.accidental_reports.*')">
        ...
        <x-sidebar.dropdown icon="fas fa-road" label="Road Closed Management" :active="request()->routeIs('admin.road-closed-fillable.*') || request()->routeIs('admin.road-closed-reports.*')">
...
>
            ...
            <x-sidebar.link route="admin.districts.index" label="Districts" icon="fas fa-city" :active="request()->routeIs('admin.districts.*')" />
            ...
            {{-- Already Existing --}}
            <x-sidebar.link route="admin.incident-types.index" label="Incident-Types" icon="fas fa-flag" :active="request()->routeIs('admin.incident-types.*')" />
            <x-sidebar.link route="admin.disaster-types.index" label="Disaster-Types" icon="fas fa-flag" :active="request()->routeIs('admin.disaster-types.*')" />
        </x-sidebar.dropdown>
    ...
    <x-sidebar.dropdown icon="fas fa-boxes" label="Resource Management" :active="request()->routeIs('admin.equipment.*') ||
        ...
        <x-sidebar.link route="admin.equipment_categories.index" label="Equipment Categories" icon="fas fa-layer-group" :active="request()->routeIs('admin.equipment_categories.*')" />
        <x-sidebar.link route="admin.manpower.index" label="Manpower" icon="fas fa-users" :active="request()->routeIs('admin.manpower.*')" />
        <x-sidebar.link route="admin.relief_material.index" label="Relief Materials" icon="fas fa-box-open" :active="request()->routeIs('admin.relief_material.*')" />
        <x-sidebar.link route="admin.deployments.index" label="Deployments" icon="fas fa-truck" :active="request()->routeIs('admin.deployments.*')" />
    </x-sidebar.dropdown>
