<div
    ...
    <div>
        ...
        <nav class="space-y-2">
            ...
            <x-sidebar.link route="admin.daily_reports_fillable.index" label="Report Headers" icon="fas fa-list-alt"
            ...
            <x-sidebar.link route="admin.tourist-visitor-details.index" label="Tourist Visitors" icon="fas fa-users"
                :active="request()->routeIs('admin.tourist-visitor-details.*')" />
            ...
            <x-sidebar.link route="admin.district-reports.index" label="District Reports" icon="fas fa-map-marked-alt"
            ...
            <button type="button"
                class="w-full flex items-center px-3 py-2 text-sm font-medium rounded-md transition-colors hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 hover:text-gray-900 dark:hover:text-white">
                <a href="/deploy"><i class="fas fa-server mr-3"></i>
                    Deploy</a>
            </button>
