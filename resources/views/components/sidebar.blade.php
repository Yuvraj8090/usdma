        ...
        <nav class="space-y-2">
            ...
            <x-sidebar.dropdown icon="fas fa-user-shield" label="Admin" :active="request()->routeIs('admin.*')">
                ...
                <x-sidebar.dropdown icon="fas fa-mountain" label="Natural Disaster Reports" :active="request()->routeIs('admin.natural-disaster-fillable.*')">
                    <x-sidebar.link route="admin.natural-disaster-fillable.index" label="Disaster Report Headers"
            ...
            <x-sidebar.dropdown icon="fas fa-car-crash" label="Accidental Reports" :active="request()->routeIs('admin.accidental_reports.*')">
                <x-sidebar.link route="admin.accidental_reports.index" label="Accident Reports" icon="fas fa-ambulance"
            ...
            <x-sidebar.dropdown icon="fas fa-file-alt" label="Daily Reports" :active="request()->routeIs('admin.daily_reports.*') ||
                ...
                request()->routeIs('admin.reports.*') ||  request()->routeIs('admin.natural-disaster-reports.*')">
