                ...
                <form action="{{ route('admin.equipment.update', $equipment->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" id="name" 
                               ...
                               class="mt-1 block w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 
                                      rounded-lg shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 dark:focus:ring-indigo-600" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="type" id="type" 
                               ...
                               class="mt-1 block w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 
                                      rounded-lg shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 dark:focus:ring-indigo-600">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="remarks" id="remarks" rows="3"
                                  class="mt-1 block w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 
                                         rounded-lg shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 dark:focus:ring-indigo-600">{{ old('remarks', $equipment->remarks) }}</textarea>
